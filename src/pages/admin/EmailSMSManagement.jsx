            ...
            <main className="dashboard-main">
                <header className="dashboard-header">
                    <div className="flex items-center gap-4">
                        <div><h1>Email & SMS</h1><p>Manage email campaigns and SMS gateways</p></div>
                    </div>
                ...
                <div style={{ padding: '2rem', textAlign: 'center', color: '#6b7280' }}>
                    <i className="ri-mail-settings-line" style={{ fontSize: '3rem', marginBottom: '1rem', display: 'block' }}></i>
                    <h3>Campaign Manager</h3>
                    <p>Configure templates and send bulk communications.</p>
                </div>
            </main>
        </div>
    );
