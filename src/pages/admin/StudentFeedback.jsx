        ...
        <div className="dashboard-container admin-dashboard">
            ...
            <aside className={`dashboard-sidebar ${isSidebarOpen ? 'open' : ''}`}>
                ...
                <nav className="sidebar-nav">
                    ...
                    <a href="/admin/feedback" className="nav-item active"><i className="ri-feedback-line"></i>Student Feedback</a>
                </nav>
            ...
            <main className="dashboard-main">
                <header className="dashboard-header">
                    <div className="flex items-center gap-4">
                        <div><h1>Student Feedback</h1><p>View and manage student feedback and ratings</p></div>
                    </div>
                ...
                <div style={{ padding: '2rem', textAlign: 'center', color: '#6b7280' }}>
                    <i className="ri-star-smile-line" style={{ fontSize: '3rem', marginBottom: '1rem', display: 'block' }}></i>
                    <h3>No Feedback Yet</h3>
                    <p>Student feedback metrics will appear here.</p>
                </div>
            </main>
        </div>
    );
